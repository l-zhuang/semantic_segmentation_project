...
checkpoint = torch.load('./run/model_sad_200.pth')
...
model.eval()
with torch.no_grad():
    predictions,loss_distill = model(images)
...
plot_bar(iou_train,miou_train,'./pic/iou_train_sad_200.png')
plot_bar(iou_val,miou_val,'./pic/iou_valid_sad_200.png')
plot_bar(iou_test,miou_test,'./pic/iou_test_sad_200.png')
