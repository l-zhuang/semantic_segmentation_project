...
class Kitti(data.Dataset):
    ...
    root='./'
    train_folder = "data_semantics/training/image_2"
    train_lbl_folder = "data_semantics/training/semantic"

    # Validation dataset root folders
    # val_folder = "data_semantics/validation/image_2"
    # val_lbl_folder = "data_semantics/validation/semantic"

    # Test dataset root folders
    test_folder = "data_semantics/testing/image_2"
    test_lbl_folder = "data_semantics/testing/semantic"
