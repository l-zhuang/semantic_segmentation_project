...
class ENet_SAD(nn.Module):
    ...
    def __init__(self, num_classes,input_size=(512,512), sad=True, encoder_relu=False, decoder_relu=True, weight_share=True,class_weights=0):
        super().__init__()
        ...
        self.iou_loss = mIoULoss(n_classes=num_classes)
    ...
    def forward(self, img, seg_gt=None, sad_loss=False):
        ...
        if seg_gt is not None :
            ...
            if self.sad:
                ...
                seg_gt_onehot = to_one_hot(seg_gt, self.num_classes)
